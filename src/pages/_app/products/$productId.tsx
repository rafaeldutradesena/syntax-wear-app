...
function RouteComponent() {
  ...
  return <section className='container mb-10 pt-44 md:pt-54 pb-10 md:px-10'>
    ...
    <div className="flex justify-center gap-10">
      ...
      <div className="text-black">
        ...
        <p className='text-sm text-[#878787]'>Você economiza: <span
          className="font-semibold">10%</span> </p>
